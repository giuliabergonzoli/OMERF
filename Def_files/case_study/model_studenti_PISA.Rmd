...
library(pdfCluster)
library(psych)
results.acc=matrix(nrow=2, ncol=4, data=rep(0,12))
results.mse=matrix(nrow=2, ncol=4, data=rep(0,12))
results.oc=matrix(nrow=2, ncol=4, data=rep(0,12))
results.ari=matrix(nrow=2, ncol=4, data=rep(0,12))
results.ck=matrix(nrow=2, ncol=4, data=rep(0,12))
results.newi=matrix(nrow=2, ncol=4, data=rep(0,12))
